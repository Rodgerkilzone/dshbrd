                                    ...
                                    <Col lg={9}>
                                        <div>
                                            <div className="text-center">
                                                ...
                                                <p className="text-muted">Get your free Flowbuilder account now.</p>
                                            </div>
                                            ...
                                            <div className="p-2 mt-5">
                                                <AvForm onValidSubmit={this.handleSubmit} className="form-horizontal" >
                                                    ...
                                                    <div className="mt-4 text-center">
                                                        <p className="mb-0">By registering you agree to the Saadabot <Link to="#" className="text-primary">Terms of Use</Link></p>
                                                    </div>
                                                </AvForm>
                                            </div>
                                            ...
                                            <div className="mt-5 text-center">
                                                ...
                                                <p>© 2020 Saadabot. Crafted with <i className="mdi mdi-heart text-danger"></i> by Saadabot</p>
                                            </div>
                                        </div>
